  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-2 pb-5 sm:flex sm:justify-between text-sm md:text-lg lg:text-xl">
          <dl className="flex">
        ...
        <div className="mt-4 border-t border-gray-200">
            ...
            <div key={product.id} className="flex space-x-6 border-b border-gray-200 py-10">
              ...
              <div className="flex flex-auto flex-col">
                <div>
                  ...
                  <p className="mt-2 text-gray-600 text-sm md:text-lg lg:text-xl">{product.description}</p>
                </div>
                <div className="mt-6 flex flex-1 items-end">
                  <dl className="flex space-x-4 divide-x divide-gray-200 sm:space-x-6 text-sm md:text-lg lg:text-xl">
                    <div className="flex">
          ...
          <div className="sm:ml-40 sm:pl-6">
            ...
            <dl className="grid grid-cols-2 gap-x-6 py-10 text-sm md:text-lg lg:text-xl">
              <div>
            ...
            <dl className="divide-y divide-gray-200 py-6">
